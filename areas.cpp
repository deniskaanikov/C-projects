...
// функиця для находжения площади робма по диагоналям
float romb (float d1, float d2) {  
    float s = d1 * d2 / 2;
    return s;
} 

// функиця для находжения площади эллипса
float ellipse (float r1, float r2) {
    float s = r1 * r2 * 3.14;
    return s;
}

// функиця для находжения площади круга
float circle (float r) {
    float s = r * r * 3.14;
    return s;
}

//функиця для нахождения площади треугольника по трем сторонам и радиусу вписанной окружности
float tr0 (float a, float b, float c, float r) {
    float s = r * (a + b + c) / 2;
    return s;
}

//функиця для нахождения площади треугольника по стороне и высоте
float tr (float a, float h) {
    float s = a * h / 2;
    return s;
}

//функиця для нахождения площади параллелограма по стороне и высоте к ней 
float parallelogram(float c, float h) {
    float s = c * h;
    return s;
}

//функиця для нахождения площади трапеции по основаниям и высоте
